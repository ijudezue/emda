...
html_start("Top Recipients Domains by Quantity");

// File name
$filename = "images/cache/rep_top_recipient_domains_by_quantity.png.".time()."";

$filter=report_start("Top Recipient Domains by Quantity");
