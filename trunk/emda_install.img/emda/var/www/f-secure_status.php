...
<TABLE CLASS="BOXTABLE" WIDTH=100%>
 <TR>
  <TD ALIGN=CENTER>
<?php passthru("/opt/f-secure/fsav/bin/dbtool /var/opt/f-secure/fsav/databases/ | awk -f ./f-secure.awk"); ?>
<?php // --FOR TESTING-- passthru("cat /var/www/html/mailscanner/f-sec_output.txt | awk -f ./f-secure.awk"); ?>
</TD>
 </TR>
</TABLE>
<?php
