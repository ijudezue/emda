...
html_start("Top Recipient Domains by Volume");

// File name
$filename = "images/cache/top_recipient_domains_by_volume.png.".time()."";

$filter=report_start("Top Recipient Domains by Volume");
